    ...
    >
      ...
      <div className={`relative w-full aspect-[4/3] ${incoming ? "opacity-60" : ""}`}>
        <div
          ...
          style={{
            background: incoming ? "#94a3b8" : teamColor,
        ...
        >
          ...
          {/* 뱃지 */}
          {isLeader && <div className="absolute top-2 right-2 text-base drop-shadow">👑</div>}
          {newbie && !isLeader && <div className="absolute top-2 right-2 text-base drop-shadow">🌱</div>}
          {incoming && <div className="absolute top-2 right-2 text-base drop-shadow">📅</div>}
      ...
      <div className="mt-2 flex items-center gap-1.5">
        <span
          ...
          style={{ backgroundColor: incoming ? "#94a3b8" : dot }}
        />
